...
public class AboutObjects {
    ...
    public void allClassesInheritFromObject() {
        ...
        assertEquals(ancestors[1], Foo.class.getSuperclass());
    }
    ...
    public void objectToString() {
        ...
        assertEquals(expectedToString, "java.lang.Object@" + Integer.toHexString(object.hashCode()).toString()); // hint: object.toString()
    }
